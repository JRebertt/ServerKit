...
EXPECTED = {
    ...
    'DnsChange': {'action', 'content', 'created_at', 'dns_provider_config_id', 'error', 'id', 'name', 'provider', 'provider_record_id', 'provider_zone_id', 'record_type', 'result', 'source'},
    ...
    'ManagedDnsRecord': {'app_id', 'content', 'created_at', 'id', 'name', 'provider', 'provider_record_id', 'provider_zone_id', 'record_type', 'source', 'updated_at'},
