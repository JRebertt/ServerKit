...
export const CORE_ROUTES = Object.freeze([
    ...
    { id: 'sso-callback', path: '/login/callback/:provider', placement: 'root', component: 'SSOCallback', guard: 'public', titleKey: 'app.routeManifest.login2', title: 'Login' },
    ...
    { id: 'services', path: '/services', placement: 'dashboard', group: 'services', component: 'Services', titleKey: 'app.routeManifest.services', title: 'Services' },
    ...
    { id: 'deploy-console', path: '/deployments/:jobId', placement: 'dashboard', group: 'services', component: 'DeployConsole', titleKey: 'app.routeManifest.deploymentActivity2', title: 'Deployment Activity' },
    { id: 'service-detail', path: '/services/:id', placement: 'dashboard', component: 'ServiceDetail', titleKey: 'app.routeManifest.services2', title: 'Services' },
    { id: 'service-detail-tab', path: '/services/:id/:tab', placement: 'dashboard', component: 'ServiceDetail', titleKey: 'app.routeManifest.services3', title: 'Services' },
    { id: 'service-detail-section', path: '/services/:id/:tab/:section', placement: 'dashboard', component: 'ServiceDetail', titleKey: 'app.routeManifest.services4', title: 'Services' },
    ...
    { id: 'domains', path: '/domains', placement: 'dashboard', group: 'domains', component: 'Domains', titleKey: 'app.routeManifest.domains', title: 'Domains' },
    ...
    { id: 'databases', path: '/databases', placement: 'dashboard', component: 'Databases', titleKey: 'app.routeManifest.databases', title: 'Databases' },
    { id: 'databases-tab', path: '/databases/:tab', placement: 'dashboard', component: 'Databases', titleKey: 'app.routeManifest.databases2', title: 'Databases' },
    { id: 'docker', path: '/docker', placement: 'dashboard', component: 'Docker', titleKey: 'app.routeManifest.docker', title: 'Docker' },
    { id: 'docker-tab', path: '/docker/:tab', placement: 'dashboard', component: 'Docker', titleKey: 'app.routeManifest.docker2', title: 'Docker' },

    { id: 'servers', path: '/servers', placement: 'dashboard', group: 'servers', component: 'Servers', titleKey: 'app.routeManifest.servers', title: 'Servers' },
    ...
    { id: 'server-detail', path: '/servers/:id', placement: 'dashboard', component: 'ServerDetail', titleKey: 'app.routeManifest.servers2', title: 'Servers' },
    { id: 'server-detail-tab', path: '/servers/:id/:tab', placement: 'dashboard', component: 'ServerDetail', titleKey: 'app.routeManifest.servers3', title: 'Servers' },
    { id: 'legacy-agent-plugins', path: '/agent-plugins', placement: 'dashboard', redirect: '/extensions', titleKey: 'app.routeManifest.extensions', title: 'Extensions' },
    ...
    { id: 'project-detail', path: '/projects/:id', placement: 'dashboard', component: 'ProjectDetail', titleKey: 'app.routeManifest.projects2', title: 'Projects' },
    { id: 'project-detail-tab', path: '/projects/:id/:tab', placement: 'dashboard', component: 'ProjectDetail', titleKey: 'app.routeManifest.projects3', title: 'Projects' },
    { id: 'workspace-detail', path: '/workspaces/:id', placement: 'dashboard', component: 'WorkspaceDetail', titleKey: 'app.routeManifest.workspace', title: 'Workspace' },
    {
        id: 'workspace-detail-tab', path: '/workspaces/:id/:tab', placement: 'dashboard', component: 'WorkspaceDetail', titleKey: 'app.routeManifest.workspace2', title: 'Workspace',
    ...
    {
        id: 'workspace-detail-section', path: '/workspaces/:id/:tab/:section', placement: 'dashboard', component: 'WorkspaceDetail', titleKey: 'app.routeManifest.workspace3', title: 'Workspace',
        titleByParam: {
    ...
    { id: 'extensions', path: '/extensions', placement: 'dashboard', group: 'marketplace', component: 'Marketplace', titleKey: 'app.routeManifest.extensions2', title: 'Extensions' },
    ...
    { id: 'style-guide-tab', path: '/style-guide/:tab', placement: 'dashboard', component: 'StyleGuide', titleKey: 'app.routeManifest.styleGuide2', title: 'Style Guide' },
    { id: 'app-map', path: '/app-map', placement: 'dashboard', component: 'AppMap', titleKey: 'app.routeManifest.appMap', title: 'App Map' },
    { id: 'app-map-tab', path: '/app-map/:tab', placement: 'dashboard', component: 'AppMap', titleKey: 'app.routeManifest.appMap2', title: 'App Map' },
    ...
    { id: 'monitoring', path: '/monitoring', placement: 'dashboard', group: 'monitoring', component: 'Monitoring', titleKey: 'app.routeManifest.monitoring', title: 'Monitoring' },
    ...
    { id: 'scheduled-jobs', path: '/monitoring/jobs/scheduled', placement: 'dashboard', group: 'monitoring', component: 'Jobs', titleKey: 'app.routeManifest.monitoring2', title: 'Monitoring' },
    ...
    { id: 'monitoring-tab', path: '/monitoring/:tab', placement: 'dashboard', group: 'monitoring', component: 'Monitoring', titleKey: 'app.routeManifest.monitoring3', title: 'Monitoring' },
    ...
    { id: 'monitor-detail', path: '/monitoring/monitors/:monitorId', placement: 'dashboard', component: 'MonitorDetail', titleKey: 'app.routeManifest.monitoring4', title: 'Monitoring' },
    { id: 'legacy-observability', path: '/observability', placement: 'dashboard', redirect: '/monitoring', titleKey: 'app.routeManifest.monitoring5', title: 'Monitoring' },
    { id: 'legacy-fleet-monitor', path: '/fleet-monitor', placement: 'dashboard', redirect: '/monitoring' },

    { id: 'backups', path: '/backups', placement: 'dashboard', group: 'backups', component: 'Backups', titleKey: 'app.routeManifest.backups', title: 'Backups' },
    { id: 'backups-tab', path: '/backups/:tab', placement: 'dashboard', group: 'backups', component: 'Backups', titleKey: 'app.routeManifest.backups2', title: 'Backups' },
    { id: 'cron', path: '/cron', placement: 'dashboard', component: 'CronJobs', titleKey: 'app.routeManifest.cronJobs', title: 'Cron Jobs' },
    { id: 'security', path: '/security', placement: 'dashboard', group: 'security', component: 'Security', titleKey: 'app.routeManifest.security', title: 'Security' },
    { id: 'security-tab', path: '/security/:tab', placement: 'dashboard', group: 'security', component: 'Security', titleKey: 'app.routeManifest.security2', title: 'Security' },
    ...
    { id: 'terminal-tab', path: '/terminal/:tab', placement: 'dashboard', component: 'Terminal', titleKey: 'app.routeManifest.terminal2', title: 'Terminal' },
    ...
    { id: 'queue-detail', path: '/queue/:groupSlug/:queueSlug', placement: 'dashboard', component: 'QueueDetail', titleKey: 'app.routeManifest.queueBus2', title: 'Queue Bus' },
    ...
    { id: 'legacy-jobs', path: '/jobs', placement: 'dashboard', redirect: '/monitoring/jobs', titleKey: 'app.routeManifest.jobs2', title: 'Jobs' },
    { id: 'legacy-scheduled-jobs', path: '/jobs/scheduled', placement: 'dashboard', redirect: '/monitoring/jobs/scheduled', titleKey: 'app.routeManifest.jobs3', title: 'Jobs' },
    { id: 'settings', path: '/settings', placement: 'dashboard', component: 'Settings', titleKey: 'app.routeManifest.settings', title: 'Settings' },
    { id: 'settings-tab', path: '/settings/:tab', placement: 'dashboard', component: 'Settings', titleKey: 'app.routeManifest.settings2', title: 'Settings' },
